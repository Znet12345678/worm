all:
	...
	i386-elf-gcc -nostdlib -m16 -c string.c -o string.o
	i386-elf-gcc -nostdlib -m16 -c main.c -o main.o
	i386-elf-gcc -nostdlib -m16 -c puts.c -o puts.o
	i386-elf-gcc -nostdlib -m16 -c lib.c -o lib.o
	i386-elf-gcc -Tlinker.ld -m16 -nostdlib puts.o lib.o main.o string.o stage2.o -o stage2.elf
